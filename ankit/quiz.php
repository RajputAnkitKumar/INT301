...
<form>
	<?php
	$fetch="select * from question where id=1";
	$query=mysqli_query($conn,$fetch);
     $row=mysqli_fetch_assoc($query);
     
     ?>
</center>
<div style="color:#444;width:400px;font-size:24px;margin-top:20px;margin-left:10px;overflow-wrap:break-word;line-height:15px">1. <?php echo $row['ques'];?></div><br>
<div id="under" style="width:auto;border-top:1px solid silver;margin-top:10px">
	<br>
